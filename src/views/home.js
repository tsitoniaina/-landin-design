...
import img1 from "../images/arts/intro-section-illustration.png";
import img2 from "../images/campanies/campany-1.png";
import img3 from "../images/campanies/campany-2.png";
import img4 from "../images/campanies/campany-3.png"
import img5 from "../images/campanies/campany-4.png"
import img6 from "../images/campanies/campany-5.png"
import img7 from "../images/campanies/campany-6.png"

import img8 from "../images/services/service-1.png"
import img9 from "../images/services/service-2.png"
import img10 from "../images/services/service-3.png"
import img11 from "../images/portfolio/portfolio-1.jpg"
            ...
            <section id="home" class="intro-section">
                <div class="container">
                    ...
                    <div class="col-md-6 intros text-end">
                        <div class="video-box">
                        <img src={img1} alt="video illutration" class="img-fluid"/>
            ...
            <section id="campanies" class="campanies">
                ...
                <div class="row">
                    ...
                    <div class="campanies__logo-box shadow-sm">
                        <img src={img2} alt="Campany 1 logo" title="Campany 1 Logo" class="img-fluid"/>
                    </div>
                    </div>
                    <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src={img3} alt="Campany 2 logo" title="Campany 2 Logo" class="img-fluid"/>
                    </div>
                    </div>
                    <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src={img4} alt="Campany 3 logo" title="Campany 3 Logo" class="img-fluid"/>
                    </div>
                    </div>
                    <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src={img5} alt="Campany 4 logo" title="Campany 4 Logo" class="img-fluid"/>
                    </div>
                    </div>
                    <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src={img6} alt="Campany 5 logo" title="Campany 5 Logo" class="img-fluid"/>
                    </div>
                    </div>
                    <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src={img7} alt="Campany 6 logo" title="Campany 6 Logo" class="img-fluid"/>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                        ...
                        <img src={img8} alt="marketing illustration" class="img-fluid"/>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
                        <div class="services__pic">
                        <img src={img9} alt="web development illustration" class="img-fluid"/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
                        <div class="services__content">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                        <div class="services__pic">
                        <img src={img10} alt="cloud hosting illustration" class="img-fluid"/>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <section id="portfolio" class="portfolio">
                    <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <img src={img11} alt="portfolio 1 image" title="portfolio 1 picture" class="img-fluid"/>
